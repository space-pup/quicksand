...
py_quicksand_disconnect(PyObject *self, PyObject *arg)
{
    ...
    conn = (quicksand_connection *)PyCapsule_GetPointer(arg,
                                 "quicksand_connection");
    if (!conn) return NULL;          /* error already set */
...
PyInit__quicksand(void)
{
    ...
    if (load_symbol("quicksand_connect", (void **)&p_quicksand_connect) < 0) return NULL;
    if (load_symbol("quicksand_disconnect", (void **)&p_quicksand_disconnect) < 0) return NULL;
    if (load_symbol("quicksand_delete", (void **)&p_quicksand_delete) < 0) return NULL;
    if (load_symbol("quicksand_delete", (void **)&p_quicksand_delete) < 0) return NULL;
    if (load_symbol("quicksand_write", (void **)&p_quicksand_write) < 0) return NULL;
    if (load_symbol("quicksand_read", (void **)&p_quicksand_read) < 0) return NULL;
    if (load_symbol("quicksand_now", (void **)&p_quicksand_now) < 0) return NULL;
    if (load_symbol("quicksand_ns", (void **)&p_quicksand_ns) < 0) return NULL;
    if (load_symbol("quicksand_ns_calibrate", (void **)&p_quicksand_ns_calibrate) < 0) return NULL;
    if (load_symbol("quicksand_sleep", (void **)&p_quicksand_sleep) < 0) return NULL;
